...
const products = [
  { webpath: '/embryoscope-plus', name: 'EMBRYOSCOPE +', brand: 'Vitrolife', path: 'embryoscope+.png' },
...
{ webpath: '/embryoscope-system', name: 'EMBRYOSCOPE TIME-LAPSE SİSTEMİ', brand: 'Vitrolife', path: 'embryoscope-system.png' },
